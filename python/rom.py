...
allmennskunnskap_spørsmål = {
    ...
    {"spørsmål":"Hvor kommer makronen originalt fra?", "alternativer":["Italia"]["Frankrike"]["Tyria"],"svar": "Italia"},
...
got_spørsmål = [
    ...
    {"spørsmål": "Who said: 'I don’t plan on knitting by the fire while men fight for me'?", "alternativer": ["Lyanna Mormont"]["Sansa Stark"]["Ser Brienne of Tarth"]["Olenna Tyrell"]}
]"""